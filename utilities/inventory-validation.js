...
/* ******************************
 * Check data in the update inventory form and return
 * errors or continue updating the new inventory vehicle.
 * ***************************** */
validate.checkUpdateData = async (req, res, next) => {
  ...
  if (!errors.isEmpty()) {
    let nav = await utilities.getNav()
    const invData = await inventoryModel.getProductById(inv_id)
